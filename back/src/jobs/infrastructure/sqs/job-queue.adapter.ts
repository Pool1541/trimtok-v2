...
export class JobQueueAdapter implements IJobQueuePort {
  async enqueueDownload(msg: DownloadMessage): Promise<void> {
  ...
  async enqueueTrim(msg: TrimMessage): Promise<void> {
    await sqs.send(new SendMessageCommand({
  ...
  async enqueueGif(msg: GifMessage): Promise<void> {
    await sqs.send(new SendMessageCommand({
  ...
  async enqueueMp3(msg: Mp3Message): Promise<void> {
    await sqs.send(new SendMessageCommand({
